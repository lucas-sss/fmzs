...
public class Pagination extends SimplePage {
	...
	public void pageView(String url,String params){
        ...
        pageView.add("共<var>" + getTotalPage() + "</var>页&emsp;到第<input type='text' id='PAGENO'  size='3' />页 <input type='button' id='skip' class='hand btn60x20' value='确定' onclick=\"javascript:window.location.href = '" + url + "?" + params + "&pageNo=' + $('#PAGENO').val() \"/>");
	}
}
